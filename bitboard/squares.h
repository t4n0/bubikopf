...
constexpr Bitboard RANK_2 = A2 | B2 | C2 | D2 | E2 | F2 | G2 | H2;
constexpr Bitboard RANK_3 = A3 | B3 | C3 | D3 | E3 | F3 | G3 | H3;
constexpr Bitboard RANK_4 = A4 | B4 | C4 | D4 | E4 | F4 | G4 | H4;
constexpr Bitboard RANK_5 = A5 | B5 | C5 | D5 | E5 | F5 | G5 | H5;
constexpr Bitboard RANK_6 = A6 | B6 | C6 | D6 | E6 | F6 | G6 | H6;
constexpr Bitboard RANK_7 = A7 | B7 | C7 | D7 | E7 | F7 | G7 | H7;
constexpr Bitboard RANK_8 = A8 | B8 | C8 | D8 | E8 | F8 | G8 | H8;

constexpr Bitboard FILE_A = A1 | A2 | A3 | A4 | A5 | A6 | A7 | A8;
constexpr Bitboard FILE_B = B1 | B2 | B3 | B4 | B5 | B6 | B7 | B8;
constexpr Bitboard FILE_C = C1 | C2 | C3 | C4 | C5 | C6 | C7 | C8;
constexpr Bitboard FILE_D = D1 | D2 | D3 | D4 | D5 | D6 | D7 | D8;
constexpr Bitboard FILE_E = E1 | E2 | E3 | E4 | E5 | E6 | E7 | E8;
constexpr Bitboard FILE_F = F1 | F2 | F3 | F4 | F5 | F6 | F7 | F8;
constexpr Bitboard FILE_G = G1 | G2 | G3 | G4 | G5 | G6 | G7 | G8;
constexpr Bitboard FILE_H = H1 | H2 | H3 | H4 | H5 | H6 | H7 | H8;

constexpr Bitboard START_RANK_WHITE = RANK_2;
constexpr Bitboard START_RANK_BLACK = RANK_7;
