...
// Value tests
const std::array<move_t, 9> ALL_MOVE_VALUES{
    MOVE_VALUE_TYPE_INVERTIBLE,         MOVE_VALUE_TYPE_CAPTURE,
    MOVE_VALUE_TYPE_PAWN_PUSH,          MOVE_VALUE_TYPE_PAWN_DOUBLE_PUSH,
    MOVE_VALUE_TYPE_EN_PASSENT_CAPTURE, MOVE_VALUE_TYPE_KINGSIDE_CASLTING,
    MOVE_VALUE_TYPE_QUEENSIDE_CASLTING, MOVE_VALUE_TYPE_PROMOTION,
    MOVE_VALUE_TYPE_PROMOTION_CAPTURE,
};
