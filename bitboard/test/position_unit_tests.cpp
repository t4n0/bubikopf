...
TEST(BoardIndxesTest,
  ...
  unit.boards[BOARD_IDX_WHITE + PAWN] = 3;
  unit.boards[BOARD_IDX_WHITE + KNIGHT] = 4;
  unit.boards[BOARD_IDX_WHITE + BISHOP] = 5;
  unit.boards[BOARD_IDX_WHITE + ROOK] = 6;
  unit.boards[BOARD_IDX_WHITE + QUEEN] = 7;
  unit.boards[BOARD_IDX_WHITE + KING] = 8;
  unit.boards[BOARD_IDX_WHITE + BOARD_IDX_ATTACK] = 9;
  unit.boards[BOARD_IDX_BLACK] = 10;
  unit.boards[BOARD_IDX_BLACK + PAWN] = 11;
  unit.boards[BOARD_IDX_BLACK + KNIGHT] = 12;
  unit.boards[BOARD_IDX_BLACK + BISHOP] = 13;
  unit.boards[BOARD_IDX_BLACK + ROOK] = 14;
  unit.boards[BOARD_IDX_BLACK + QUEEN] = 15;
  unit.boards[BOARD_IDX_BLACK + KING] = 16;
