...
TEST(BoardIndxesTest, GivenUniqueNumberToEachBitboard_ExpectRespectiveUniqueNumber)
{
    ...
    unit.boards_[kBlackBoard + PAWN] = 3;
    unit.boards_[kBlackBoard + KNIGHT] = 4;
    unit.boards_[kBlackBoard + BISHOP] = 5;
    unit.boards_[kBlackBoard + ROOK] = 6;
    unit.boards_[kBlackBoard + QUEEN] = 7;
    unit.boards_[kBlackBoard + KING] = 8;
    unit.boards_[kUnused1Board] = 9;
    unit.boards_[kWhiteBoard] = 10;
    unit.boards_[kWhiteBoard + PAWN] = 11;
    unit.boards_[kWhiteBoard + KNIGHT] = 12;
    unit.boards_[kWhiteBoard + BISHOP] = 13;
    unit.boards_[kWhiteBoard + ROOK] = 14;
    unit.boards_[kWhiteBoard + QUEEN] = 15;
    unit.boards_[kWhiteBoard + KING] = 16;
