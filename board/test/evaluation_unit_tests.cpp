...
class EvaluationTest : public ::testing::TestWithParam<EvaluationComparisonOperatorParameters>
{
};
...
const std::vector<EvaluationComparisonOperatorParameters> comparison_permutations = {
...
INSTANTIATE_TEST_SUITE_P(AllPermutations, EvaluationTest, ::testing::ValuesIn(comparison_permutations));
