...
std::enable_if_t<Behaviour::is_concrete, Evaluation> evaluate(const Position& position)
{
    const std::map<SquareId, float> piece_values{
        {SquareId::WhitePawn, 1.0F},
        {SquareId::WhiteKnight, 3.0F},
        {SquareId::WhiteBishop, 3.0F},
        {SquareId::WhiteRook, 5.0F},
        {SquareId::WhiteQueen, 9.0F},
        {SquareId::WhiteKing, 100.0F},
        {SquareId::BlackPawn, -1.0F},
        {SquareId::BlackKnight, -3.0F},
        {SquareId::BlackBishop, -3.0F},
        {SquareId::BlackRook, -5.0F},
        {SquareId::BlackQueen, -9.0F},
        {SquareId::BlackKing, -100.0F},
        {SquareId::Empty, 0.0F},
    };
